...
class ConversionsTest {
  ...
  // android.util.Log and throws under the blaze host stub, so it is left to Robolectric-backed
  // coverage - as the sibling enum converters (e.g. response modality) already are.
  @Test
  ...
  // is left out: its drop path logs a warning, which the blaze host android.util.Log stub rejects.
  @Test
