 ...
 */
/**
 * The two attribute keys this server injects itself, as opposed to the OpenTelemetry semantic
 * conventions around them; only these follow the contract's spelling.
 */
