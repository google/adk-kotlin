...
/**
 * Builds a JVM A2A [Client] using the SDK's JSON-RPC transport over [httpClient].
 *
 * Framework-internal building block behind [A2AAgent]; not part of the public API.
 */
internal fun jvmA2AClient(
  agentCard: AgentCard,
...
fun A2AAgent(
  ...
  A2AAgentImpl(
    name = name,
    a2aClient = jvmA2AClient(agentCard, httpClient),
    agentCard = agentCard,
    streaming = streaming,
    subAgents = subAgents,
