 ...
 *   `ReflectiveTools` use it as the schema name; when unset, the KSP path uses the Kotlin parameter
 *   name, while the reflective path requires it because Java does not retain parameter names in
 *   bytecode.
