 ...
 * @property bypassMultiToolsLimit When true, the tool can be used alongside other tools: it is
 *   wrapped in a sub-agent and exposed as a function tool, since a built-in retrieval tool cannot
 *   otherwise coexist with other tools in a single request.
 */
