...
/** Maps a SDK [GenAiBlockedReason] to an ADK [FinishReason]. */
internal fun GenAiBlockedReason.toFinishReason(): FinishReason =
  when (this) {
    GenAiBlockedReason.SAFETY -> FinishReason.SAFETY
    GenAiBlockedReason.BLOCKLIST -> FinishReason.BLOCKLIST
    GenAiBlockedReason.PROHIBITED_CONTENT -> FinishReason.PROHIBITED_CONTENT
    GenAiBlockedReason.IMAGE_SAFETY -> FinishReason.IMAGE_SAFETY
