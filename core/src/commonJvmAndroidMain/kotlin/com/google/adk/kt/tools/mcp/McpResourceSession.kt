...
/**
 * The MCP server answered and rejected the request (JSON-RPC error). Retrying repeats the same
 * round trip and evicting the session would punish other in-flight callers.
 */
internal class McpServerRejectedException(
  message: String,
