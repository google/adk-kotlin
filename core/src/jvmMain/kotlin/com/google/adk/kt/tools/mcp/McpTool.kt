...
internal constructor(
  ...
  override suspend fun run(context: ToolContext, args: Map<String, Any?>): Any =
    try {
      ...
      // Existing JVM callers catch the transport/SDK failure after the retry budget. Wrapping
      // that in McpToolExecutionException would be a backward-compat break. Android is new and
      // may wrap; resource tools still use McpToolExecutionException on both platforms.
