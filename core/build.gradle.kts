...
// Keep off `kspAndroid`: that plus `core` shipping no @AppFunctionSignature is what stops every
// dependent becoming a declared provider, and either alone is silent.
